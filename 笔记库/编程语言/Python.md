...
### 语言基础
- [Python基础语法.md](./Python/Python基础语法.md) — 类（self、魔法方法）、数据类型、控制流

### 工具生态
- [Python源.md](./Python/Python源.md) — pip 国内镜像（清华 / 阿里云 / 中科大 / 豆瓣）配置
...
- 与 [神经网络/Agent](../神经网络/Agent.md) 的"模型优化"是上下游——本目录讲编译器，Agent 侧讲上层应用
- 与 [计算机系统/MLIR入门.md](../计算机系统/MLIR入门.md) 共享编译器 IR 概念
- 与 [神经网络/AIGC](../神经网络/AIGC.md) 互补——本目录讲 Python 端编译，神经网络侧讲 ONNX/TensorRT 端转换
