...
### Swift 语法
- 变量 / 常量、可选类型、闭包、协议
- [Swift学习笔记.md](./Swift/Swift学习笔记.md)
...
- [Swift-Metal编程入门.md](./Swift/Swift-Metal编程入门.md)

### SwiftUI 实战
完整 Todo List App：数据模型 + 列表 + 增删改。Xcode 15+ / iOS 17+ 环境。

- [SwiftUI实战-TodoApp.md](./Swift/SwiftUI实战-TodoApp.md)

---

## 横向关联

- 与 [GPU编程](../GPU编程.md) 的 OpenGL Compute Shader 是 GPU 编程的两条生态路线
