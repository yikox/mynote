...
初始化和设计文档的起始模板：`project-management-template.md`、`knowledge-summary-template.md`、`main-design-template.md`、`module-design-template.md`、`module-change-template.md`、`architecture-change-template.md`、`adr-template.md`、`ai-rules-snippet.md`（init 合并进目标项目 CLAUDE.md/AGENTS.md 的工作流规则片段）。
